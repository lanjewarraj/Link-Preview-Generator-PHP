...
<body>
    ...
    <div class="row" ng-app="MyApp" ng-controller="MyController">
        <div class="col-md-12 demo-github text-center">
            <iframe src="https://ghbtns.com/github-btn.html?user=leonardocardoso&repo=link-preview&type=watch&count=true" frameborder="0" scrolling="0" width="170px" height="20px"></iframe>
            <iframe src="https://ghbtns.com/github-btn.html?user=leonardocardoso&repo=link-preview&type=fork&count=true" frameborder="0" scrolling="0" width="170px" height="20px"></iframe>

        </div>

        <div class="col-sm-4 demo-col-padding">
            <link-preview tpage="%N ➜ %N" btext="Post This Preview" type="top" cbtext="Go Back" iamount="10" />
        </div>
        <div class="col-sm-4 demo-col-padding">
            <link-preview placeholder="Placeholder" limage="http://4.bp.blogspot.com/-L2Td-3QtUTo/UcbAvCQTYvI/AAAAAAAAAUM/Z4_GBilAu9g/s1600/spinner_64_3f4fa14117c586c002a98cd7c5fbb2d3.gif" btext="Submit" ltext="" ttext="" bclass="default" />
        </div>
        <div class="col-sm-4 demo-col-padding">
            <link-preview placeholder="What's in your mind?" type="left" limage="demo/img/loader.gif" bclass="success"/>
        </div>
